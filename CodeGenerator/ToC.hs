...
instance ToC ModuleHeader where
    toC c (Module i p) = makeHeaderAndBodyLines [generatePos c (Module i p)] <> makeBodyLines ["#include \"" ++ destFile c ++ ".h\""] <> makeHeaderAndBodyLines ["// This is module " ++ toCString c i ++ " generated by emperor from " ++ (show . sourceFile) c]
